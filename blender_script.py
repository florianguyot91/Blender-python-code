...
def import_audio(file_path):
    ...
    # audio_name = "A Like Supreme by SAMURAI (Refused).mp3"

    audio_filepath = os.path.dirname(file_path)
...
def audio_processing(file_path):
    ...
    # bpy.data.objects[meter + str(1)].animation_data = None
    ...
    # bpy.ops.anim.channels_select_all(override, action='SELECT')
